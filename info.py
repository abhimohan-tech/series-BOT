...
START_MESSAGE = environ.get('START_MESSAGE', '👋 𝙷𝙴𝙻𝙾 {user}\n\n𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 {bot},\n𝙸 𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 𝙼𝙾𝚅𝙸𝙴𝚂 & 𝚂𝙴𝚁𝙸𝙴𝚂, 𝙹𝚞𝚜𝚝 𝚂𝚎𝚗𝚍 𝙼𝚎 𝚂𝚎𝚛𝚒𝚎𝚜 𝚘𝚛 𝙼𝚘𝚟𝚒𝚎𝚜 𝙽𝚊𝚖𝚎 & 𝙴𝙽𝙹𝙾𝚈 😍')
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🎬 𝖳𝗂𝗍𝗅𝖾: <a href={url}>{title}</a></b>({kind})\n\n<b>🎭 𝖦𝖾𝗇𝗋𝖾 : {genres}</b>\n<b>📆 𝖱𝖾𝗅𝖾𝖺𝗌𝖾 : <a href={url}>{release_date}</a></b>\n<b><b>🌟 𝖱𝖺𝗍𝗂𝗇𝗀: <a href={url}/ratings>{rating} / 10</a></b> (based on {votes} user ratings.)\n<b>🎙 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 :</b> {languages}\n<b>⏱️ 𝖱𝗎𝗇𝗍𝗂𝗆𝖾:</b> {runtime} Minutes\n<b>🌐 𝖢𝗈𝗎𝗇𝗍𝗋𝗒:</b> {countries}\n\n<b>👥 Starring :</b> <a href={url}>{cast}</a>\n<b>🎥 Director :</b> <a href={url}>{director}</a>\n<b>📝 Writers :</b>{writer}\n\n<b>✍️Story Line:</b> <code>{plot}</code>\n<b>Also Known as:</b> {aka}")
